...
testthat::test_that("onda 2 i18n keys exist with pt/en translations", {
    ...
    required_keys <- c(
        ...
        "help_workflow_title",
        "help_workflow_subtitle",
        "help_workflow_step_upload_title",
        "help_workflow_step_upload_desc",
        "help_workflow_step_map_title",
        "help_workflow_step_map_desc",
        "help_workflow_step_validate_title",
        "help_workflow_step_validate_desc",
        "help_workflow_step_generalize_title",
        "help_workflow_step_generalize_desc",
        "help_workflow_step_export_title",
        "help_workflow_step_export_desc",
        "help_author_role",
