...
- `docs/DECISIONS.md`: ADR-078 (mascara `land 10m` embutida); ADR-081 (catalogo DwC completo separado do conjunto-base); ADR-082 (mapeamento sob demanda via `rv$extra_terms`); ADR-083 (remocao da coluna de exemplos da wiki + correcao do seletor de pageLength).
