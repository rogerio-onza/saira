...
To practice this and the next steps, download [`ocorrencias-demo.csv`](../../assets/exemplo/ocorrencias-demo.csv), Saíra's demonstration dataset: 1,075 real occurrences of Brazilian species across several biomes, deliberately imperfect (many columns to map, coordinates with problems to review, a few names to check, and threatened species for generalization).
:::
