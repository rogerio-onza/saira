...
::: {.callout-tip}
## Reapply the mapping in one go
Collections often re-import spreadsheets with the same structure. Importing the template reapplies the whole column → term vocabulary at once and saves each pair as an alias, so only new or renamed columns need review.
:::
