...
Download the sample spreadsheet [`ocorrencias-demo.csv`](../../assets/exemplo/ocorrencias-demo.csv) and follow the tutorials with it. It is Saíra's demonstration dataset: 1,075 real occurrences of Brazilian species across several biomes, deliberately imperfect so you can practice every step: many Portuguese columns to map, coordinates with problems to review, a few names to check (one of them misspelled), and threatened species to try generalization.
:::
