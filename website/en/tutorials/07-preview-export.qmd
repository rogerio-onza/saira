...
The metadata (`eml.xml`) is assembled **automatically**: Saíra uses a default title, computes the geographic bounding box and date range from your data, and applies the CC0 license by default — there is nothing to fill in. Fine-tuning the metadata (institution, responsible parties, final license) happens later, in the IPT, at publication time.
