...
```{=html}
<figure class="shot">
  <img src="../../assets/img/9-painel-validação.png" alt="Left panel of coordinate validation: status of the mapped columns (latitude, longitude, country), the Complete/Fast Profile selector and the Validate Coordinates button">
...
```{=html}
<figure class="shot">
  <img src="../../assets/img/9.1-mapa-pontos-validados.png" alt="Geographic Distribution map with records as points colored by situation (valid, invalid, sea, zero/equal, reference) and the color legend below the map">
...
```{=html}
<figure class="shot">
  <img src="../../assets/img/9.2-diagnostico-coordenadas-pilulas.png" alt="Filter buttons above the Coordinate Diagnostics table, with the Row, Diagnosis, Latitude, Longitude, Country and ISO3 columns">
...
```{=html}
<figure class="shot">
  <img src="../../assets/img/9.3-correcao-coordenadas-transpostas.png" alt="Transposed-coordinate correction panel, with the record count, an old → new example and the Correct transposed coordinates button">
...
```{=html}
<figure class="shot">
  <img src="../../assets/img/9.4-correcao-pais-faltando-coordenadas..png" alt="Fill-country-from-coordinates panel, with the count, an example and the Fill country from coordinates button">
