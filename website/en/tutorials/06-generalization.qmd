...
```{=html}
<figure class="shot">
  <div class="frame"><span class="ph-label">screenshot · Generalization tab with the detected sensitive records</span></div>
...
```{=html}
<figure class="shot">
  <div class="frame"><span class="ph-label">screenshot · decision cascade for a threat group</span></div>
...
```{=html}
<figure class="shot">
  <div class="frame"><span class="ph-label">screenshot · justification field (dataGeneralizations)</span></div>
...
```{=html}
<figure class="shot">
  <div class="frame"><span class="ph-label">screenshot · map with original point, generalized cell and border alert</span></div>
