...
```{=html}
<figure class="shot">
  <img src="../../assets/img/1-tela-inicial-EN.png" alt="Saíra start screen: Home step with the upload panel and the list of required columns">
  <figcaption><b>Figure 8.</b> Saíra's start screen, with the language selector (PT-BR/EN), the numbered steps and the upload panel.</figcaption>
</figure>
```
