...
```{=html}
<figure class="shot">
  <div class="frame"><span class="ph-label">screenshot · aba Generalização com os registros sensíveis detectados</span></div>
...
```{=html}
<figure class="shot">
  <div class="frame"><span class="ph-label">screenshot · cascata de decisão de um grupo de ameaça</span></div>
...
```{=html}
<figure class="shot">
  <div class="frame"><span class="ph-label">screenshot · campo de justificativa (dataGeneralizations)</span></div>
...
```{=html}
<figure class="shot">
  <div class="frame"><span class="ph-label">screenshot · mapa com ponto original, célula generalizada e alerta de fronteira</span></div>
