...
Para praticar esta e as próximas etapas, baixe [`ocorrencias-demo.csv`](../assets/exemplo/ocorrencias-demo.csv), o conjunto de demonstração do Saíra: 1.105 ocorrências de espécies brasileiras de vários biomas, propositalmente imperfeito. São 24 colunas para mapear, dia, mês e ano em colunas separadas, números de tombo faltando e repetidos, coordenadas trocadas e fora de faixa, registros de países vizinhos, espécies ameaçadas para a generalização e espécies exóticas invasoras. Cada etapa dos tutoriais tem algo para resolver nele.
:::
