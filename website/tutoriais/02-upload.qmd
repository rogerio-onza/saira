...
Para praticar esta e as próximas etapas, baixe [`ocorrencias-demo.csv`](../assets/exemplo/ocorrencias-demo.csv), o conjunto de demonstração do Saíra: 1.107 ocorrências de espécies brasileiras de vários biomas, propositalmente imperfeito. São 25 colunas para mapear, dia, mês e ano em colunas separadas, uma coluna de data com formatos misturados (com barra, com hora, só mês e ano) e dois anos impossíveis, números de tombo faltando e repetidos, coordenadas trocadas e fora de faixa, registros de países vizinhos, espécies ameaçadas para a generalização e espécies exóticas invasoras. Cada etapa dos tutoriais tem algo para resolver nele.
:::

Na etapa **Início**, arraste o arquivo para a área indicada ou clique para selecioná-lo.
...
```{=html}
<figure class="shot">
  <img src="../assets/img/2-area-upload-resumo-arquivo.png" alt="Painel de upload do Saíra com o resumo do arquivo: 1.107 registros, 25 colunas, 0,3 MB">
