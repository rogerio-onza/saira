...
| Armadilha fotográfica | `.zip` | Pacotes Camtrap DP e exportações do Wildlife Insights (ver abaixo) |
...
Para praticar esta e as próximas etapas, baixe [`ocorrencias-exemplo.csv`](../assets/exemplo/ocorrencias-exemplo.csv) — um conjunto pequeno e propositalmente imperfeito (com um acento problemático e uma coordenada invertida), ideal para treinar a validação.
:::
