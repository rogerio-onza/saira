...
Flora do Brasil e Fauna do Brasil são **baixadas e armazenadas localmente** na primeira vez que você as usa. Depois disso, a validação roda mesmo sem internet e fica mais rápida. O Saíra mostra o status de cada base (não baixada, baixando, atualizada) e a versão local. O GBIF é consultado conforme a necessidade.
:::
...
A decisão é **reaplicada automaticamente** a todas as linhas com aquele mesmo nome — como a validação agrupa nomes idênticos, você revisa cada um uma única vez e a correção vale para o conjunto inteiro. É o que mais economiza tempo em planilhas grandes com o mesmo erro repetido.
...
::: {.callout-note}
## De onde vem a lista
A lista embutida corresponde à **Portaria MMA nº 148, de 7 de junho de 2022** (que atualiza a Portaria nº 443/2014), do Ministério do Meio Ambiente. Texto oficial: <https://in.gov.br/en/web/dou/-/portaria-mma-n-148-de-7-de-junho-de-2022-406272733>.
:::
...
Aqui a etapa apenas **sinaliza** o que é sensível. A proteção efetiva das coordenadas — generalizar a localização ou omiti-la — acontece na **[exportação](06-preview-exportacao.qmd)**, onde a categoria de ameaça define o nível de generalização.
