...
As bases que você seleciona aqui também definem qual **status de conservação** o Saíra adiciona ao `dynamicProperties` da exportação: uma base **brasileira** contribui com a categoria **MMA** (e a portaria que listou o táxon), e o **GBIF** contribui com a categoria **IUCN** global. Uma linha curta acima do relatório informa quantos registros receberão cada um. As chaves são gravadas quando você gera o pacote — veja **[exportação](07-preview-exportacao.qmd)**.
