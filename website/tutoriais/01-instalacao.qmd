...
```{=html}
<figure class="shot">
  <img src="../assets/img/1-tela-inicial.png" alt="Tela inicial do Saíra: etapa Início com o painel de upload e a lista de colunas obrigatórias">
  <figcaption><b>Figura 8.</b> Tela inicial do Saíra, com o seletor de idioma (PT-BR/EN), as etapas numeradas e o painel de upload.</figcaption>
</figure>
```
