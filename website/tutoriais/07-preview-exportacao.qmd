...
- **Datas** convertidas para o formato ISO (`AAAA-MM-DD`), qualquer que seja o separador digitado na planilha. Uma data sem dia sai como `AAAA-MM` e uma data com hora, como `AAAA-MM-DDThh:mm`. Se o ano estiver fora do intervalo entre 1600 e o ano atual, o Saíra avisa e mostra as linhas: o erro é de digitação e só você sabe qual era a data certa. O aviso não bloqueia a exportação.
