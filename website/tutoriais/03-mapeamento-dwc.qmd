...
<figure class="shot">
  ...
  <figcaption><b>Figura 1.</b> O botão <b>Auto-mapear</b> na barra de ações, ao lado de Resetar, Adicionar termo e Importar modelo.</figcaption>
</figure>
```
...
<figure class="shot">
  ...
  <figcaption><b>Figura 2.</b> Cards de mapeamento após o Auto-mapear: <span class="term">numero_tombo</span> → <span class="term">catalogNumber</span> e <span class="term">coletor</span> → <span class="term">recordedBy</span>, ambos marcados como SUGERIDO para você confirmar.</figcaption>
</figure>
```
...
<figure class="shot">
  ...
  <figcaption><b>Figura 3.</b> O botão <b>Adicionar termo</b> na barra de ações.</figcaption>
</figure>
<figure class="shot">
  <img src="../assets/img/4.1-adicionar-termo-pop-up.png" alt="Janela 'Adicionar termo DwC' com o seletor de termo">
  <figcaption><b>Figura 4.</b> A janela <b>Adicionar termo DwC</b>: escolha o termo no seletor e confirme para incluí-lo como um novo card.</figcaption>
</figure>
```
...
<figure class="shot">
  ...
  <figcaption><b>Figura 5.</b> No card <span class="term">basisOfRecord</span>, escolha a coluna-fonte (aqui, <span class="term">tipo_de_registro</span>) e abra o <b>Assistente basisOfRecord</b>.</figcaption>
</figure>
```
...
<figure class="shot">
  ...
  <figcaption><b>Figura 6.</b> O assistente mapeia <b>cada valor</b> para um termo DwC — Espécime preservado → PreservedSpecimen, Observação → HumanObservation, Armadilha fotográfica → MachineObservation — com prévia ao vivo antes de salvar.</figcaption>
</figure>
```
...
<figure class="shot">
  ...
  <figcaption><b>Figura 7.</b> Painel de mapeamento do Saíra, com sugestões automáticas à esquerda e pré-visualização Darwin Core à direita.</figcaption>
</figure>
```
